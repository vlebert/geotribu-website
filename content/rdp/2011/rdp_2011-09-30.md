...
### Du côté de la ville roseSuite à la [lettre ouverte](http://opendata-toulouse.numahel.net/doku.php/lettre) du 4 avril dernier sur l'ouverture des données de la communauté urbaine à M. Pierre Cohen - président du Grand Toulouse - les choses ont bien avancé :slightly_smiling_face: Le 22 octobre prochain, le maire devrait faire l'annonce de l'ouverture du portail 'Toulouse Data' lors du festival [la Novela](http://novela.toulouse.fr/) - festival des savoirs partagés  
